...
```bash
git clone https://github.com/nearxdev/skills.git
cd agent-skills
npm ci
npm run build
```
...
nx g @nearx/skill-plugin:skill my-skill --category=development

nx g @nearx/skill-plugin:skill my-skill \
