...
**If you are the author of any content included here** and would like it removed or updated, please [open an issue](https://github.com/nearxdev/skills/issues/new) or contact the maintainers directly. We will act promptly.
...
To report a vulnerability, open a [GitHub Security Advisory](https://github.com/nearxdev/skills/security/advisories/new) (private, only visible to maintainers).
